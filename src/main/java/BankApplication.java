...
public class BankApplication {
    ...
    public Client getDemoClient1() {
        ...
        Client client = new Client(name, Gender.valueOf(environment.getProperty("client1.gender")));
        ...
        client.setRepository(applicationContext.getBean(MapClientRepository.class));
        return client;
    }
    ...
    public Client getDemoClient2() {
        ...
        Client client = new Client(name, Gender.valueOf(environment.getProperty("client2.gender")));
